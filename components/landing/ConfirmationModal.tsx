                ...
                <>
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-wedding-cream border border-wedding-pink-accent/30 rounded-xl p-8 md:p-12 max-w-lg w-full max-h-[90vh] overflow-y-auto"
                        ...
                        >
                            ...
                            <div className="text-center mb-8">
                                ...
                                >
                                    <Heart
                                        className={`mx-auto mb-4 ${isAttending ? "text-wedding-pink-accent" : "text-wedding-dove"}`}
                                        size={48}
                                        fill="currentColor"
                                    />
                                </motion.div>
                            ...
                            {isAttending && (
                                <div className="bg-wedding-pearl/50 rounded-lg p-6 mb-6">
                                    <h4
                                        className="text-wedding-pink-accent text-xs tracking-[0.2em] uppercase mb-4"
                                        style={{ fontFamily: "var(--font-body)" }}
                                    >
                                        Event Details
                                    </h4>
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            <MapPin className="text-wedding-pink-accent mt-0.5 flex-shrink-0" size={16} />
                                            <div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            <Clock className="text-wedding-pink-accent mt-0.5 flex-shrink-0" size={16} />
                                            <div>
                                                <p className="text-wedding-charcoal text-sm font-medium" style={{ fontFamily: "var(--font-body)" }}>
                                                    February 14, 2026
                                                </p>
                            ...
                            <button
                                onClick={onClose}
                                className="w-full bg-wedding-pink-accent text-wedding-charcoal py-4 text-xs tracking-[0.2em] uppercase font-semibold hover:bg-wedding-darkpink transition-all duration-300 rounded-lg"
                                style={{ fontFamily: "var(--font-body)" }}
                            >
                                Close
                            </button>
