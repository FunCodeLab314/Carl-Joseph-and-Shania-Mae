...
export function GallerySection() {
    ...
    // Scatter positions for each card
                                            ...
                                            {index === 0 ? (
                                                <>
                                                    <div className="w-full h-full flex flex-col items-center justify-center">
                                                        <ImageIcon className="text-wedding-burgundy/40 mb-3 md:mb-4" size={48} />
                                                        <p className="text-wedding-gold/60 text-sm md:text-lg" style={{ fontFamily: "var(--font-body)" }}>
                                                            {galleryImages.length} Photos
                                                        </p>
                                                    </div>

                                                    {/* Click to expand overlay */}
                                                    <div className="absolute inset-0 bg-gradient-to-t from-wedding-black/80 via-transparent to-transparent flex items-end justify-center pb-6 md:pb-10">
                                                ...
                                                <div className="w-full h-full flex items-center justify-center">
                                                    <ImageIcon className="text-wedding-burgundy/20" size={32} />
                                                </div>
                                            )}
                                        </motion.div>
                                    ))}
