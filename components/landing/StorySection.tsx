        ...
        >
            ...
            <div className="absolute inset-0 opacity-5">
                <div
                    ...
                    style={{
                        backgroundImage: `radial-gradient(circle at 2px 2px, var(--color-wedding-lilac) 1px, transparent 0)`,
                        ...
                        <div className="relative order-1 md:order-1">
                            <div className="relative aspect-[4/5] md:aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl">
                                ...
                                {currentStory.date && (
                                    ...
                                    >
                                        <div className="bg-wedding-lilac/90 backdrop-blur-sm px-4 py-2 rounded-full">
                                            <span
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <motion.div
                                        ...
                                        className="w-20 h-[2px] bg-wedding-lilac mx-auto md:mx-0 mb-6 md:mb-8 origin-left"
                                    />
                                    ...
                                    >
                                        <Heart
                                            className="text-wedding-lilac/60 mx-auto md:mx-0"
                                            size={24}
                                            fill="currentColor"
                                        />
                                    </motion.div>
                ...
                <div className="mt-8 md:mt-12 flex flex-col items-center gap-6">
                    ...
                    <div className="w-full max-w-md">
                        <div className="h-1 bg-wedding-champagne/40 rounded-full overflow-hidden">
                            <motion.div
                                className="h-full bg-wedding-lilac rounded-full"
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                            ...
                            className="p-3 rounded-full bg-wedding-charcoal/5 hover:bg-wedding-lilac/20 border border-wedding-lilac/30 text-wedding-charcoal hover:text-wedding-lilac transition-all duration-300 group"
                        ...
                        <button
                            ...
                            className="p-4 rounded-full bg-wedding-lilac hover:bg-wedding-darklilac text-wedding-charcoal transition-all duration-300 shadow-lg group"
                            ...
                            >
                                <span
                                    className={`absolute inset-0 rounded-full transition-all duration-300 ${index === currentIndex
                                        ? "bg-wedding-lilac"
                                        : "bg-wedding-champagne hover:bg-wedding-lilac/60"
                                        }`}
                                />
                            </button>
                        ))}
            ...
            <div className="relative z-10 pt-8 pb-16 md:pb-24">
                <div className="flex justify-center items-center gap-4">
                    <div className="w-12 h-[1px] bg-wedding-lilac/40" />
                    <Heart
                        className="text-wedding-lilac/40"
                        size={16}
                        fill="currentColor"
                    />
                    <div className="w-12 h-[1px] bg-wedding-lilac/40" />
