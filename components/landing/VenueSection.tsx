                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    ...
                    >
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <div className="w-16 h-[2px] bg-wedding-lilac mx-auto lg:mx-0" />
                        </div>

                        {/* Venue Details - Two Columns (Ceremony | Reception) */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {/* Ceremony */}
                            <div className="bg-white/50 rounded-xl p-5 border border-wedding-lilac/10">
                                <div className="flex items-center gap-2 mb-3">
                                    <Heart className="text-wedding-lilac" size={20} />
                                    <h3 className="text-lg md:text-xl text-wedding-charcoal" style={{ fontFamily: "var(--font-heading)" }}>
                                        Ceremony
                                    </h3>
                                </div>
                                <p className="text-wedding-lilac font-semibold mb-2 tracking-widest text-xs">3:00 PM</p>
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 bg-wedding-lilac text-wedding-ivory px-3 py-2 rounded-md text-[10px] tracking-[0.1em] uppercase hover:bg-wedding-darklilac transition-colors shadow-md font-medium"
                            ...
                            <div className="bg-white/50 rounded-xl p-5 border border-wedding-lilac/10">
                                <div className="flex items-center gap-2 mb-3">
                                    <Utensils className="text-wedding-lilac" size={20} />
                                    <h3 className="text-lg md:text-xl text-wedding-charcoal" style={{ fontFamily: "var(--font-heading)" }}>
                                        Reception
                                    </h3>
                                </div>
                                <p className="text-wedding-lilac font-semibold mb-2 tracking-widest text-xs">5:00 PM</p>
                                <p className="text-wedding-charcoal text-sm md:text-base font-medium mb-1" style={{ fontFamily: "var(--font-heading)" }}>
                                    The Bella Plaza
                                </p>
                                <p className="text-wedding-slate text-xs mb-4" style={{ fontFamily: "var(--font-body)" }}>
